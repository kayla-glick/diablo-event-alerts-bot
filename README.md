...
The bot sets up a `#d4-event-alerts` channel and a `@D4 Event Alerts` role that will be pinged when events pop up.

Users can use the `/d4-alerts` command to subscribe to or unsubscribe from alerts.
